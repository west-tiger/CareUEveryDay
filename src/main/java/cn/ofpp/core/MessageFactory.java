...
public class MessageFactory {
    ...
    private static List<WxMpTemplateData> buildData(Friend friend) {
        ...
        WxMpTemplateData friendName = TemplateDataBuilder.builder().name("friendName").value(friend.getFullName()).color("#D91AD9").build();
        WxMpTemplateData howOld = TemplateDataBuilder.builder().name("howOld").value(friend.getHowOld().toString()).color("#F77234").build();
        ...
        WxMpTemplateData nextBirthday = TemplateDataBuilder.builder().name("nextBirthday").value(friend.getNextBirthdayDays()).color("#771F06").build();
        WxMpTemplateData nextMemorialDay = TemplateDataBuilder.builder().name("nextMemorialDay").value(friend.getNextMemorialDay()).color("#551DB0").build();
        ...
        WxMpTemplateData windpower = TemplateDataBuilder.builder().name("windpower").value(weather.getWindpower()).color("#3491FA").build();
        WxMpTemplateData humidity = TemplateDataBuilder.builder().name("humidity").value(weather.getHumidity()).color("#F77234").build();
        ...
        list.add(friendName);list.add(howOld);list.add(howLongLived);list.add(nextBirthday);list.add(nextMemorialDay);list.add(province);
        list.add(city);list.add(weather1);list.add(temperature);list.add(winddirection);list.add(winddirection);list.add(windpower);
        list.add(humidity);list.add(author);
        list.add(origin);
        list.add(content);
